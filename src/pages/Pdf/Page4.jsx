    ...
    return(<>
        <PageWrapper>
            ...
            />
                ...
                {`私たちの遺伝子検査は、750以上のSNP（単一ヌクレオチド多型）を解析することで、あなたの体質や健康リスクをさまざまな側面から把握することができます。\n
これらの情報を基に、個々の遺伝的特性に最適化された健康管理プランを提供し、日常生活の質を向上させるお手伝いをいたします。\n
従来の遺伝子検査の多くは、希少疾患・難病リスクが高い傾向にある・低い傾向にあることを伝えています。\n
せっかく遺伝子検査をしても「じゃあ何をすれば良いのか」と次の一歩に繋がる情報はありませんでした。\n
私たちの遺伝子検査は、医学論文に基づいた情報から、健康管理に役立つ情報提供を目指しております。\n
