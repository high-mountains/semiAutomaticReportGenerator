...
const Periodanalyze = (props) => {
    ...
    const EnhancedPeriodanalyze = withPeriodanalyze([
        ...
        data: {
            ...
            qualities1:[
                "抗酸化物質を豊富に含む食品（ベリー類、緑黄色野菜類、緑茶など）を積極的に摂取する。", 
                "オメガ-3脂肪酸（魚類、亜麻仁油、チアシードなど）を含む食品を摂取し、炎症を軽減する。", 
                "コエンザイムQ10、カルニチン、ビタミンB群など、ミトコンドリア機能をサポートする栄養素を積極的に摂取する。",
                "Lカルニチンを含む食品（赤身の肉、牛肉、ラム肉など）を積極的に摂取する。",
                "抗ヒスタミン作用を持つ食品（だいこん、ターメリック、ニンジンなど）を積極的に摂取する。",
                "ポリフェノールを豊富に含む食品（ダークチョコレート、リンゴ、トマト、タマネギ、シナモン、オレガノなど）を積極的に摂取する。",
                "元気になって運動したい！と思ったら、有酸素運動や筋力トレーニングを取り入れてみましょう。ミトコンドリアの機能を刺激されてさらにエネルギーを感じるようになりますが、無理は禁物です。",
                "睡眠をしっかりとる（睡眠不足はフリーラジカルの生成を増加させ、ミトコンドリアに酸化ストレスを与え、ミトコンドリアの機能が低下するから）",
            ],
