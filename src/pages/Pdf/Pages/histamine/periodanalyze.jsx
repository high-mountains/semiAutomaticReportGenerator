...
const Periodanalyze = (props) => {
    ...
    const EnhancedPeriodanalyze = withPeriodanalyze([
        ...
        data: {
            ...
            qualities1:[
                {
                    content:"ヒスタミンを多く含む食品（熟成チーズ、加工肉、発酵食品、アルコール、特定の魚類など）の摂取を控える。",
                },
                {
                    content: "アルコールの代謝産物のアセトアルデヒドはヒスタミン分解酵素を阻害のでアルコールを控える"
                },
                {
                    content: "グルテンフリー、カゼインフリーで腸内フローラを整える。"
                },
                {
                    content: "新鮮な食品を選び、保存料や添加物が少ない食品を摂取する。"
                },
                {
                ...
                {
                    content: "寝る前のリラクゼーションルーティンを設け、睡眠の質を向上させる。"
                },
                {
                    content: "寝室にスマートフォンなどを持ち込まない、機内モードにしておく。寝室とWifiルーターの距離を取る。"
                },
                {
                    content: "アレルゲンを避けるための対策を講じ、アレルギー症状を軽減する。"
                },
                {
                    content: "家の清掃や空気清浄機の使用などで、環境中のアレルゲンを減らす。"
                },
                {
                    content: "マイコトキシン（カビ毒）の原因となるような汚染された穀類や住居、エアコンなどを避ける。"
                },
            ],
