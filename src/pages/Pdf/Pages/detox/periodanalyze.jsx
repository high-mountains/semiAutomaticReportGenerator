...
const Periodanalyze = (props) => {
    ...
    const EnhancedPeriodanalyze = withPeriodanalyze([
        ...
        data: {
            firstSenctences: "デトックスタイプの子どもは、消化器系が敏感であり、食べ物や環境の変化に対して体が過剰に反応しやすい傾向があります。解毒機能が未発達であるため、環境毒素に対する感受性が高く、これが発育や行動に影響を与える可能性があります。また、アレルギーやアトピーのリスクも高まることが考えられます。遺伝的に特定の毒素、例えば化学物質やカビ毒などに対して敏感で、そのような場所を嫌がることがあり、本人や周囲の人がその理由を理解できない場合、臆病だと思われてしまうこともあるかもしれません。", 
            secondSenctences: "ホルモンバランスの変化により、肌荒れやアレルギー反応が強くなる可能性があります。この時期は心の変化も激しく、ストレスを感じやすい傾向があります。ホルモンの変動によって解毒能力が変化しやすく、食生活や生活環境の影響を受けやすい時期でもあり、不安定な精神状態や肌トラブルが現れることがあるかもしれません。第二次成長期には、エストロゲン、テストステロン、成長ホルモンなどの主要なホルモンの代謝産物が体内に蓄積しやすくなり、ホルモンバランスが乱れ、それが成長や発達に影響を与える可能性があります。さらに、プラスチック製品などから取り込まれる環境ホルモンが体内に入ることで、解毒の負担が増えることが考えられます。特に徹夜や夜型の生活が続くと、肝臓の解毒能力が低下しやすくなり、思春期の夜型生活が解毒機能の悪化を引き起こす要因となることがあるため、注意が必要です。", 
            thirdSenctences: "ストレスや生活習慣が解毒能力に大きな影響を与える時期であり、仕事や家庭のストレスが肝臓の解毒能力を低下させ、慢性的な疲労や消化器系のトラブルを引き起こしたり、再発させる可能性があります。さらに、飲酒や喫煙、薬物の使用によって肝臓への負担が増え、代謝産物が体内に蓄積しやすくなる時期でもあります。このような状態は「リバーストレス（Liver Stress）」とも呼ばれ、肝臓への負担が原因で、明け方にトイレで目が覚めたり、夜間に頻繁に目が覚めることが増えてくることがあります。さらに、毒素の代謝産物の影響により、視野がぼやけるといった症状に悩まされることもあります。", 
