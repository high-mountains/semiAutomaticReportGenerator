    ...
    const EnhacedConcept = withPeriodanalyze([
        ...
        {Component: Quality,
            data:{
                ...
                qualities1: ["気持ちのアップダウンが激しい", "エネルギー不足を感じやすい", "頭がぼんやりする時がある"],
                qualities2: ["ハイポメチレーション： \n 神経伝達物質の代謝が正常に行われず、バランスが崩れる。神経伝達物質の過剰産生や不適切な代謝により感情の乱れ。 \n 免疫系の機能に異常を起こし、自己免疫疾患や慢性炎症を招きやすい。"],
                sidebarColor: maincolor
            }
        },
