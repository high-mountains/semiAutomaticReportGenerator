...
const Periodanalyze = (props) => {
    ...
    const EnhancedPeriodanalyze = withPeriodanalyze([
        ...
        data: {
            ...
            qualities1:[
                "葉酸、ビタミンB6、ビタミンB12、メチオニンなど、メチレーションに必要な栄養素を含む食品（緑黄色野菜、豆類、卵、肉類、魚など）を積極的に摂取する。", 
                "オメガ-コリンを多く含む食品（メチル基の供給源となる）：卵、大豆製品、鶏肉、ブロッコリー", 
                "ベタインを多く含む食品（ホモシステインをメチオニンにするときにメチル基を供給）：ビーツ、ホウレンソウ、ほたて",
                "グルタチオンやメチオニン、SAMeなどのメチレーションサポートサプリメントを検討する。",
                "加工食品や添加物の摂取を控え、新鮮な食材を選ぶ。",
                "セロトニンを増やすために、同じリズムの繰り返しの運動、ウォーキングなどを積極的に取り入れる。",
                "ドーパミンを増やすために、フェニルアラニンを含む食品（肉類、魚、大豆製品、卵など）チロシンを含む食品（肉、魚、大豆製品、ナッツ類）を摂取する",
            ],
            // qualities1:[
            //     "汗を積極的にかく", 
            //     "シャワーではなく、湯船につかる時間を", 
