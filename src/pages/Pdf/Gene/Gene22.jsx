...
const initialGeneData = [
  {
    ...
    level: 0,
    description:
      "この遺伝子に変異がある場合、ミトコンドリア内でエネルギー産生が不十分になる可能性があります。COX4I2（Cytochrome c Oxidase Subunit 4 Isoform 2）は、シトクロムcオキシダーゼのサブユニット4のアイソフォーム2をコードしています。シトクロムcオキシダーゼはミトコンドリア電子伝達系の複合体IVに属し、酸素を最終電子受容体として利用してATPを生成します。",
  },
  {
    geneName: "IDO2",
